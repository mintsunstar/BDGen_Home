  ...
  var SUBPAGE_I18N = {
    'about-intro': {
      ko: {
        ...
        'cap-1-p': 'SKT PASS 모바일지갑, 디지털 혁신대학 출입 서비스 등 수백만 사용자 규모의 서비스를\n실제로 상용화한 검증된 실전 경험을 보유합니다.',
        'cap-2-h': '<span class="highlight">다양한 블록체인</span> 기술 스택',
        'cap-2-p': 'DID · NFT · 출입인증 등 응용 솔루션부터 Hyperledger Fabric · Ethereum 인프라까지,\n전 계층을 자체 개발 · 운영하는 기술 보유 기업입니다.',
        'cap-3-h': '상용 서비스 <span class="highlight">플랫폼 구축</span> 경험',
        'cap-3-p': '모바일 앱 · 웹 · IF 서버 · 백오피스를 포함한 풀스택 플랫폼을 처음부터 끝까지 직접 설계하고 납품합니다.',
        'cap-4-h': '기획부터 런칭까지 <span class="highlight">단일 팀 완결</span>',
        'cap-4-p': '서비스 기획 → UX 디자인 → 개발 → QA → 런칭의 전 과정을 하나의 팀에서 일관되게 처리하여 품질과 일정을 모두 보장합니다.',
        'cap-5-h': '<span class="highlight">대규모 플랫폼</span> 장기 운영 경험',
        'cap-5-p': '체계적인 프로세스 기반의 효율적 운영과 UX 개선, VoC 피드백 루프로 대형 통신사 플랫폼을 장기간 안정적으로 운영한 노하우를 보유합니다.',
      ...
      en: {
        ...
        'cap-1-h': 'Blockchain <span class="highlight">application service commercialization</span> experience',
        'cap-1-p': 'Proven real-world experience commercializing services for millions of users, including the SKT PASS mobile wallet and Digital Innovation University access services—\nfield-tested in production.',
        'cap-2-h': '<span class="highlight">Diverse blockchain</span> technology stack',
        'cap-2-p': 'From application solutions for DID, NFT, and access authentication to Hyperledger Fabric and Ethereum infrastructure,\nwe develop and operate every layer in-house as a technology company.',
        'cap-3-h': 'Commercial <span class="highlight">service platform</span> build experience',
        'cap-3-p': 'We design and deliver full-stack platforms covering mobile apps, web, IF servers, and back office—from the ground up to handover.',
        'cap-4-h': 'From planning to launch, <span class="highlight">one team, end to end</span>',
        'cap-4-p': 'A single team handles planning, UX design, development, QA, and launch in one flow—ensuring both quality and schedule with consistency.',
        'cap-5-h': 'Long-term <span class="highlight">large-scale platform</span> operation experience',
        'cap-5-p': 'Process-driven operations, continuous UX improvement, and VoC feedback—know-how for stable long-term operation of large telecom platforms.',
    ...
    'about-history': {
      ko: {
        ...
        'cert-1-issuer': '중소벤처기업부 · 2026. 04. 01',
        'cert-2-name': '벤처기업확인서',
      ...
      en: {
        ...
        'cert-1-issuer': 'Ministry of SMEs and Startups · 2026. 04. 01',
    ...
    'careers': {
      ko: {
        ...
        'careers-apply-file-err-type': 'PDF 형식만 업로드 가능합니다',
        'careers-apply-file-err-size': '파일 크기는 10MB 이하만 가능합니다',
        'careers-apply-err-name': '이름을 입력해 주세요.',
        'careers-apply-err-email': 'E-mail을 입력해 주세요.',
        'careers-apply-err-phone': '연락처를 입력해 주세요.',
        'careers-apply-err-position': '지원 포지션을 선택해 주세요.',
        'careers-apply-err-resume': '이력서 PDF를 첨부해 주세요.',
        'careers-apply-err-portfolio': '포트폴리오 PDF를 첨부해 주세요.',
        'careers-apply-err-privacy': '개인정보 수집 동의가 필요합니다',
        'careers-apply-sending': '접수 중...',
        'careers-apply-success': '지원서가 접수되었습니다. 검토 후 연락드리겠습니다.',
        'careers-apply-fail': '접수에 실패했습니다. 다시 시도해 주세요.',
      ...
      en: {
        ...
        'careers-apply-file-err-type': 'Only PDF files can be uploaded.',
        'careers-apply-file-err-size': 'File size must be 10 MB or less.',
        'careers-apply-err-name': 'Please enter your name.',
        'careers-apply-err-email': 'Please enter your email.',
        'careers-apply-err-phone': 'Please enter your phone number.',
        'careers-apply-err-position': 'Please select a position.',
        'careers-apply-err-resume': 'Please attach your resume (PDF).',
        'careers-apply-err-portfolio': 'Please attach your portfolio (PDF).',
        'careers-apply-err-privacy': 'Consent to personal data collection is required.',
        'careers-apply-sending': 'Submitting...',
        'careers-apply-success': 'Your application has been received. We will contact you after review.',
        'careers-apply-fail': 'Submission failed. Please try again.',
